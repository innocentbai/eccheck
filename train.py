...
def main():
    ...
    # 加载分词器
    tokenizer = GPT2Tokenizer.from_pretrained(model_path) # 加载分词器
    ...
    train_dataset = train_dataset.map( # 批量分词 input_ids/attention_mask
        tokenize_function,
        batched=True,
        remove_columns=["text"],
        num_proc=24
    ...
    train_loader = DataLoader( # input_ids/attention_mask------label
        train_dataset,
